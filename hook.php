...
function plugin_ocsinventoryng_install() {
   ...
   if (!$DB->tableExists("glpi_plugin_ocsinventoryng_bitlockerstatuses")
      ...
      //INSTALL
      $DB->runFile(GLPI_ROOT . "/plugins/ocsinventoryng/install/mysql/1.7.8-empty.sql");
      ...
      if (!$DB->tableExists('glpi_plugin_ocsinventoryng_snmplinkreworks')) {
      ...
      // Update 1.7.6
      if ($DB->tableExists("glpi_plugin_ocsinventoryng_snmpocslinks")
          && !$DB->fieldExists('glpi_plugin_ocsinventoryng_snmpocslinks', 'ocstype')) {

         $query = "ALTER TABLE `glpi_plugin_ocsinventoryng_snmpocslinks` ADD `ocstype` INT(11) DEFAULT NULL;";
      ...
      if (!$DB->tableExists("glpi_plugin_ocsinventoryng_winsecdetails")) {
         $DB->runFile(GLPI_ROOT . "/plugins/ocsinventoryng/install/mysql/1.7.8-update.sql");
      }/*1.7.8*/
