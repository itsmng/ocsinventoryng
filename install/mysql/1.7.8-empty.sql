...
CREATE TABLE `glpi_plugin_ocsinventoryng_ocsservers` (
  ...
  `import_user_group_default` tinyint(1) NOT NULL DEFAULT '1',
  ...
  `import_winsecdetails` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `tag_limit` TEXT COLLATE utf8_unicode_ci DEFAULT NULL,
  `tag_exclude` TEXT COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `glpi_plugin_ocsinventoryng_ipdiscoverocslinks` (
  ...
  `plugin_ocsinventoryng_ocsservers_id` int(11) NOT NULL DEFAULT '0',
  `status` VARCHAR(255) DEFAULT 'identified',
  PRIMARY KEY (`id`),
  KEY `plugin_ocsinventoryng_ocsservers_id` (`plugin_ocsinventoryng_ocsservers_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
### Dump table glpi_plugin_ocsinventoryng_snmplinkreworks
DROP TABLE IF EXISTS `glpi_plugin_ocsinventoryng_snmplinkreworks`;
